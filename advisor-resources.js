...
let ADVISOR_RESOURCES = [{
  ...
  "children": [{
    ...
    "children": [{
      ...
      "desc": "Use this with buyers before or during buyer consultations.",
      "icon": "📄",
      "type": "PDF",
    ...
    "children": [{
      ...
      "desc": "Use this for listing appointments and seller presentation meetings.",
      "icon": "📄",
      "type": "PDF",
    ...
    "children": [{
      ...
      "desc": "Use this with sellers before or during listing conversations.",
      "icon": "📄",
      "type": "PDF",
  ...
  "children": [{
    ...
    "desc": "Open this file to view, print, download, or share as needed.",
    "type": "Folder",
    "children": [{
      "icon": "📄",
    ...
    "children": [{
      ...
      "desc": "Link not yet added. Add the final file link in the Admin Center when ready.",
      "type": "PDF",
      "url": "",
      "section": "Operations & Compliance"
    }],
