let QUICK_LINKS = [{
  ...
  "label": "Brokerage Engine",
  "desc": "Open Brokerage Engine for listing workflows, brokerage tools, and transaction-related access.",
  "icon": "🦁",
  "type": "Brokerage Engine",
  ...
  "desc": "Access MoxiWorks, ActivePipe, Luxury Presence, and other advisor marketing platforms.",
  "icon": "👥",
  ...
  "children": [{
    ...
    "desc": "Open Luxury Presence for website and digital marketing tools.",
    "icon": "✨",
    "type": "Marketing Platform",
    "url": "https://login.luxurypresence.com/u/login/identifier?state=hKFo2SBtY1JqUzRVR0Y3dWpoR3NvaGxuSUF3ME5VSUlIUnBncqFur3VuaXZlcnNhbC1sb2dpbqN0aWTZIEV3SXU5azNiX2FSZW5LN1JIUUktckJJc0xPTGdvQTlXo2NpZNkgQ0xzSFlLWVlmbnltR0RhYVR5TGtrSWxiMWZKTjRweHY",
    "section": "Marketing Tools"
  }]
}, {
  "label": "Your Email",
  ...
  "label": "MLS",
  "desc": "Access FMLS / Remine and Georgia MLS from one place.",
  "icon": "🏠",
  "type": "MLS",
  "section": "MLS & Real Estate",
  "children": [{
    "label": "FMLS / Remine",
    "desc": "Open FMLS and Remine MLS tools.",
    "icon": "🏠",
    "type": "MLS",
  ...
  "label": "Warranty Deed",
  "desc": "Self-service or advisor-assisted options for warranty deed and GSCCCA search support.",
  "icon": "📜",
  "type": "GSCCCA Search",
  "section": "MLS & Real Estate",
  "children": [{
    "label": "Self Service Search",
    "desc": "Use GSCCCA Search for self-service legal description and warranty deed research.",
    "icon": "🔎",
    "type": "GSCCCA Search",
  ...
  "desc": "Access ACH deposit and wiring instruction options for earnest money deposits through brokerage accounts.",
  "icon": "💵",
  "type": "ACH / Wiring",
  "section": "MLS & Real Estate",
  "children": [{
    "label": "ACH Deposit",
    "desc": "Submit an earnest money deposit by ACH.",
    "icon": "🏦",
    "type": "Deposit Link",
    "url": "",
    "section": "Earnest Money Deposit"
  }, {
    "label": "Wiring Instructions",
    "desc": "Access wiring instructions used through brokerage accounts.",
    "icon": "🧾",
  ...
  "desc": "Find and view company files in one simple place, including PDFs, PowerPoints, Google Docs, Google Slides, videos, folders, and advisor guides.",
  "icon": "📚",
